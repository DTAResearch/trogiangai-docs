...
<GoalBox>
  Hệ thống được xây dựng nhằm **hỗ trợ sinh viên trong quá trình học tập**:
  - Chủ động theo dõi tiến độ và kết quả học tập
  - Hiểu rõ điểm mạnh – điểm yếu để cải thiện
  - Truy cập dễ dàng vào kiến thức, bài giảng, và kiểm tra
  - Sử dụng trợ lý AI để học tập hiệu quả hơn mỗi ngày
</GoalBox>
