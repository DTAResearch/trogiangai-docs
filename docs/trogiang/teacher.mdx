...
<GoalBox>
  Hệ thống hỗ trợ những chức năng cụ thể, thiết thực, không phức tạp hóa thao tác giảng dạy, giúp Giảng viên/Giáo viên nâng cao chất lượng lớp học.
  1. Giảng viên/Giáo viên giao bài học trước cho sinh viên học tại nhà, thời gian lên lớp để giải đáp nâng cao, làm bài tập vận dụng
     - Cho phép Giảng viên/Giáo viên upload hoặc nhúng tài nguyên (Docx, PDF, Markdown) một cách nhanh chóng, không rườm rà.
     - Dashboard cho Giảng viên/Giáo viên thấy tổng quan tình hình trước buổi học.
  2. Hỗ trợ Giảng viên/Giáo viên giảng dạy chuyên sâu trong lớp
     - Cho phép tạo nhanh hoạt động tại lớp như Kiểm tra thông qua Trợ giảng lớp học.
     - Nhanh chóng tạo đa dạng câu hỏi trong bài kiểm tra của học sinh.
  3. Giảng viên/Giáo viên có thể tái sử dụng bài giảng, nội dung cũ
     - Cho phép lưu, nhân bản bài học, hoạt động lớp, học liệu, trợ lý AI từ các kỳ trước.
     - Có thể chỉnh sửa lại nhanh chóng và dùng cho lớp mới mà không cần tạo từ đầu.
  4. Giảng viên/Giáo viên cũng cần học & cộng tác
     <!-- - Gợi ý cải thiện nội dung bài học (nếu có dữ liệu): phần nào nhiều sinh viên bỏ qua, phần nào gây nhầm lẫn... -->
     - Có không gian để chia sẻ học liệu, bài giảng giữa các Giảng viên/Giáo viên (cùng ngành hoặc khác ngành).
</GoalBox>
